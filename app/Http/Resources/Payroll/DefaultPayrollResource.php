    ...
    public function toArray(Request $request): array
    {
        try {
            return [
                ...
                'pay_date_for_humans' => $this->formatForHumans($this->pay_date),
                ...
                'total_non_taxable_and_taxable_earnings' => NumberHelper::format($this->total_non_taxable_and_taxable_earnings),
